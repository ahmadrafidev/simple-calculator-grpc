...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SquareRoot = channel.unary_unary(
                ...
                request_serializer=calculator__pb2.SquareRootRequest.SerializeToString,
                response_deserializer=calculator__pb2.SquareRootResponse.FromString,
                _registered_method=True)
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SquareRoot': grpc.unary_unary_rpc_method_handler(
                    servicer.SquareRoot,
                    request_deserializer=calculator__pb2.SquareRootRequest.FromString,
                    response_serializer=calculator__pb2.SquareRootResponse.SerializeToString,
            ),
    }
...
class Calculator(object):
    ...
    def SquareRoot(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/calculator.Calculator/SquareRoot',
            calculator__pb2.SquareRootRequest.SerializeToString,
            calculator__pb2.SquareRootResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
